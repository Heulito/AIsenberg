...
st.write("""
# Highest Prediction of IC50-Value


You can investigate the molecule further by moving or zooming into it [*6*].

""")
# Sidebar, visualisation of the best molecule
st.sidebar.header("Please fill in the **SMILES** of the molecule with the highest IC50 value predicted." )
compound_smiles=st.sidebar.text_input("SMILES input here:","COC(=O)NC1=NC2=C(N1)C=C(C=C2)C(=O)C3=CC=CC=C3")
